...
import com.weirddev.scalalock.api.LockRepository
import com.weirddev.scalalock.mongo.LockStates.LockState
...
/**
  ...
  * @author Yaron Yamin
  */
protected class MongoDistributedLockRepository(mongoDb: MongoDatabase, locksCollectionName:String = "lock_registry")(implicit ec: ExecutionContext) extends LockRepository {
