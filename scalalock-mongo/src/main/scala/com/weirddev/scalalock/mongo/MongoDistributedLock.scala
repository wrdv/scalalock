...
/**
  ...
  * @author Yaron Yamin
  */
class MongoDistributedLock(mongoDb: MongoDatabase, locksCollectionName:String = "lock_registry")(implicit ec: ExecutionContext) extends DistributedLock(new MongoDistributedLockRepository(mongoDb,locksCollectionName)(ec))(ec)
